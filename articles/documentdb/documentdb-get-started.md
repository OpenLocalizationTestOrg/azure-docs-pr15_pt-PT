...
Copie e cole o código seguinte para o seu método de **GetStartedDemo** sob a criação de base de dados. Isto vai criar uma coleção de documento com o nome *FamilyCollection_oa*.
