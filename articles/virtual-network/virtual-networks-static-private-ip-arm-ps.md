<properties 
   pageTitle="Como configurar um endereço IP estático privado no Gestor de recursos do Azure utilizando o PowerShell | Microsoft Azure"
   description="Noções sobre endereços IP estáticos privados e como geri-los no Gestor de recursos do Azure utilizando o PowerShell"
...
# <a name="how-to-set-a-static-private-ip-address-in-resource-manager-by-using-powershell"></a>Como configurar um endereço IP estático privado no Gestor de recursos utilizando o PowerShell

[AZURE.INCLUDE [virtual-networks-static-private-ip-selectors-arm-include](../../includes/virtual-networks-static-private-ip-selectors-arm-include.md)]

[AZURE.INCLUDE [virtual-networks-static-private-ip-intro-include](../../includes/virtual-networks-static-private-ip-intro-include.md)]

[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)]Este artigo abrange o modelo de implementação do Gestor de recursos. Também pode [Gerir estático endereço IP privado no modelo de implementação clássica](virtual-networks-static-private-ip-classic-ps.md).

[AZURE.INCLUDE [virtual-networks-static-ip-scenario-include](../../includes/virtual-networks-static-ip-scenario-include.md)]

O exemplo PowerShell comandos abaixo esperar um ambiente simple já tiver criado com base no cenário acima. Se pretender executar os comandos, tal como estes são apresentados neste documento, primeiro a criar o ambiente de teste descrito na [criar um vnet](virtual-networks-create-vnet-arm-ps.md).
...
1. Definir variáveis para a conta de armazenamento, localização, grupo de recursos e as credenciais ser utilizado. Terá de introduzir um nome de utilizador e palavra-passe para a VM. O grupo de conta e de recursos de armazenamento tem de existir.
...
3. Obter a rede virtual e sub-rede que pretende criar a VM no.

        $vnet = Get-AzureRmVirtualNetwork -ResourceGroupName TestRG -Name TestVNet  
        $subnet = $vnet.Subnets[0].Id

4. Se for necessário, crie um endereço IP público para aceder a VM a partir da Internet.

        $pip = New-AzureRmPublicIpAddress -Name TestPIP -ResourceGroupName $rgName -Location $locName -AllocationMethod Dynamic

5. Crie uma imagem utilizando o endereço IP privado estático que pretende atribuir à VM. Certifique-se de IP do intervalo sub-rede que está a adicionar a VM para. Este é o passo principal neste artigo, onde definir o IP privado para ser estático.
...
6. Crie a VM utilizando o NIC criado anteriormente.
...
Para ver as estáticas privadas IP informações de endereço a VM criada com o script acima, execute o seguinte comando PowerShell e observar os valores para *PrivateIpAddress* e *PrivateIpAllocationMethod*:
...
Para remover o endereço IP estático privado adicionada à VM no script acima, execute os seguintes comandos do PowerShell:
