<properties
 pageTitle="Calcular pontuações de testes de referência para Linux VMs | Microsoft Azure"
 description="Comparar as pontuações de testes de referência cluster CoreMark para VMs Azure executar Linux"
...
# <a name="compute-benchmark-scores-for-linux-vms"></a>Calcular pontuações de testes de referência para Linux VMs

As seguintes pontuações de testes de referência CoreMark mostram o desempenho de cluster de alinhamento de VM de alto desempenho do Azure executar Ubuntu. Calcule pontuações de testes de referência também estão disponíveis para [Windows VMs](virtual-machines-windows-compute-benchmark-scores.md).




## <a name="a-series---compute-intensive"></a>A série - com muitos cluster


Tamanho | vCPUs | Nós an | CPU | Será executado | Iterações/seg. | StdDev
------- | ------ | ---- | -------| ---- | ---- | -----
...
Standard_G3 | 8 | 1 | Intel Xeon E5-2698B v3 @ GHz de 2 | 84 | 107,522 | 4,537
Standard_G4 | 16 | 1 | Intel Xeon E5-2698B v3 @ GHz de 2 | 83 | 195,116 | 5,024
Standard_G5 | 32 | 2 | Intel Xeon E5-2698B v3 @ 2 GHz | 84 | 360,329 | 14,212

## <a name="gs-series"></a>Série s
...
Números de Linux foram calculados ao executar [CoreMark](http://www.eembc.org/coremark/faq.php) no Ubuntu. CoreMark foi configurado com o número de threads definido para o número de CPUs virtuais e simultaneidade definido como PThreads. O número de destino de iterações foi ajustado com base no desempenho esperado para fornecer um tempo de execução de pelo menos 20 segundos (normalmente muito mais longo). O resultado final representa o número de iterações concluída dividido pelo número de segundos demorou para executar o teste. Cada teste tiver sido executado pelo menos sete vezes no cada VM. Testa (exceto para H series_ foram executar no Outubro de 2015 no VMs vários na cada região público Azure a VM foi suportada na data executar.

## <a name="next-steps"></a>Próximos passos



* Para as capacidades de armazenamento, detalhes do disco e considerações adicionais para escolher entre tamanhos VM, consulte o artigo [tamanhos para máquinas virtuais](virtual-machines-linux-sizes.md).

* Para executar os scripts CoreMark Linux VMs, transfira o [pacote de script CoreMark](http://download.microsoft.com/download/3/0/5/305A3707-4D3A-4599-9670-AAEB423B4663/AzureCoreMarkScriptPack.zip).