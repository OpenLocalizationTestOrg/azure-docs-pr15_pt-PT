<properties
 pageTitle="Calcular pontuações de testes de referência para Windows VMs | Microsoft Azure"
 description="Comparar as pontuações de testes de referência cluster SPECint para VMs Azure executar o Windows Server"
...
# <a name="compute-benchmark-scores-for-windows-vms"></a>Calcular pontuações de testes de referência para VMs do Windows

As seguintes pontuações de testes de referência SPECInt mostram o desempenho de cluster de alinhamento de VM de alto desempenho do Azure executar o Windows Server. Calcule pontuações de testes de referência também estão disponíveis para [Linux VMs](virtual-machines-linux-compute-benchmark-scores.md).
...
Tamanho | vCPUs | Nós an | CPU | Será executado | Taxa de base AVG | StdDev
------- | ------ | ---- | -------| ---- | ---- | -----
...
## <a name="g-series-gs-series"></a>Série de G, série s
...
Windows números foram calculados através da execução [de 2006 SPECint](https://www.spec.org/cpu2006/results/rint2006.html) no Windows Server. SPECint foi executado através da opção de taxa de base (SPECint_rate2006), com uma cópia por core. SPECint é composta por 12 testes separados, cada executar três vezes, tendo o valor médio de cada teste e ponderação-los para formar uma pontuação composta. Os testes foram, em seguida, execute através de vários VMs para fornecer as pontuações de média apresentadas.


## <a name="next-steps"></a>Próximos passos

* Para as capacidades de armazenamento, detalhes do disco e considerações adicionais para escolher entre tamanhos VM, consulte o artigo [tamanhos para máquinas virtuais](virtual-machines-windows-sizes.md).
