...
|---|---|
|SSHKEYDATA   | SSH principais dados utilizados para proteger o acesso à máquina Virtual. Para obter informações sobre a criação de um par de chaves SSH, consulte o artigo [Criar SSH teclas para Linux VMs no Azure](virtual-machines-linux-mac-create-ssh-keys.md).  |
|ADMINUSERNAME   | Nome de utilizador de administração que é utilizado na máquina virtual e a base de dados do SQL Azure.  |
|SQLADMINPASSWORD | Palavra-passe que é utilizado na base de dados do SQL Azure.  |
...
[Passo 1 - arquitetura de aplicação com modelos de Gestor de recursos do Azure](./virtual-machines-linux-dotnet-core-2-architecture.md)
