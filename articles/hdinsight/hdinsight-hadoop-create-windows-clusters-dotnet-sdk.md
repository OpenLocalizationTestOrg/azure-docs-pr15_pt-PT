<properties
   pageTitle="Criar clusters baseados no Windows Hadoop no HDInsight utilizando .NET SDK | Microsoft Azure"
    description="Saiba como criar HDInsight clusters para utilizar o .NET SDK do Azure HDInsight."
   services="hdinsight"
   documentationCenter=""
   tags="azure-portal"
   authors="mumian"
...
# <a name="create-windows-based-hadoop-clusters-in-hdinsight-using-net-sdk"></a>Criar clusters baseados no Windows Hadoop no HDInsight utilizando .NET SDK

[AZURE.INCLUDE [selector](../../includes/hdinsight-selector-create-clusters.md)]


Saiba como criar clusters HDInsight utilizando .NET SDK. Para outras criação do cluster ferramentas e funcionalidades, clique em Selecionar o separador na parte superior desta página ou consulte [métodos de criação de Cluster](hdinsight-provision-clusters.md#cluster-creation-methods).
...
O HDInsight .NET SDK fornece bibliotecas do cliente .NET que tornam mais fácil de trabalhar com HDInsight a partir de uma aplicação do .NET Framework. Siga as instruções abaixo para criar uma aplicação de consola do Visual Studio e cole o código para criar um cluster.

A aplicação requer um grupo de recursos Azure e a conta de armazenamento predefinida.  O [anexo A](#appx-a-create-dependent-components) fornece um script PowerShell para criar os componentes dependentes.

**Para criar uma aplicação de consola do Visual Studio**

1. Crie uma nova aplicação de consola do c# no Visual Studio.
2. Execute o seguinte comando de Nuget na consola de gestão de pacote Nuget.
...
7. Prima **F5** para executar a aplicação. Uma janela de consola deverá ser aberto e apresenta o estado da aplicação. Também lhe ser pedido para introduzir as credenciais de conta Azure. Pode demorar alguns minutos para criar um cluster de HDInsight.
...
##<a name="appx-a-create-dependent-components"></a>Componentes de dependentes AppX-A criar

Utilizar o PowerShell Azure seguinte script pode ser para criar os componentes dependentes necessários pela aplicação .NET neste tutorial.
