<properties
   pageTitle="Restaurar dados para um cliente de Windows ou Windows Server a partir do Azure utilizando o modelo de implementação clássica | Microsoft Azure"
...
# <a name="restore-files-to-a-windows-server-or-windows-client-machine-using-the-classic-deployment-model"></a>Restaurar ficheiros para um servidor ou Windows máquina de cliente do Windows utilizando o modelo clássico de implementação
...
Em ambos os casos, os dados serem recuperados do cofre a cópia de segurança do Azure.
...
5. Selecione o volume a partir do qual pretende restaurar o ficheiro.
    ...
    ![Volume e a data](./media/backup-azure-restore-windows-server-classic/volanddate.png)

6. Selecione os itens que pretende recuperar. Pode múltiplas/ficheiros de pastas que pretende restaurar.

    ![Selecione ficheiros](./media/backup-azure-restore-windows-server-classic/selectfiles.png)
...
- *Cofre exemplo* – cofre a cópia de segurança a que estão registados *máquina de origem* e *o computador de destino* . <br/>
...
2. Certifique-se de que estão registados para a *máquina de destino* e a *máquina de origem* para o mesmo cofre cópia de segurança.
...
5. Fornece o ficheiro de credenciais do cofre que corresponde aos *Cofre de exemplo*. Se o ficheiro de credenciais do cofre for inválido (ou expirados) Transferir um ficheiro de credenciais do cofre novo a partir do *Cofre de exemplo* no portal do Azure clássico. Assim que o ficheiro de credenciais do Cofre é fornecido, é apresentado o cópia de segurança cofre relativamente ao ficheiro de credenciais do cofre.
...
8. Selecione o volume e a data no ecrã seguinte. Para procurar o ficheiro de pasta/nome que pretende restaurar.
    ...
    ![Itens de pesquisa](./media/backup-azure-restore-windows-server-classic/searchitems.png)

9. Selecione a localização onde os ficheiros precisam de ser restaurada.

    ![Restaurar a localização](./media/backup-azure-restore-windows-server-classic/restorelocation.png)
...
- [Descrição geral de cópia de segurança Azure](http://go.microsoft.com/fwlink/p/?LinkId=222425)
- [Cópia de segurança máquinas virtuais Azure](backup-azure-vms-introduction.md)
- [Cópia de segurança das cargas de trabalho do Microsoft](backup-azure-dpm-introduction.md)
