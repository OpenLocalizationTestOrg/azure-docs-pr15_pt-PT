<properties
   pageTitle="Elementos da linguagem armazém de dados SQL Transact-SQL | Microsoft Azure"
   description="Lista de ligações para conteúdos de referência para os elementos de idioma Transact-SQL utilizada para armazém de dados SQL."
...
- [chaves reservadas](https://msdn.microsoft.com/library/ms189822.aspx)
...
- [UTILIZAR](https://msdn.microsoft.com/library/ms188366.aspx)

## <a name="batches-control-of-flow-and-variables"></a>Secções, controlo de fluxo e variáveis

- [COMEÇAR A... FIM](https://msdn.microsoft.com/library/ms190487.aspx)
...
- [ACCIONAR](https://msdn.microsoft.com/library/ee677615.aspx)
- [EXPERIMENTE... CAPTURAS](https://msdn.microsoft.com/library/ms175976.aspx)
- [TEMPO](https://msdn.microsoft.com/library/ms178642.aspx)

## <a name="operators"></a>Operadores
- [+ (Adicionar)](https://msdn.microsoft.com/library/ms178565.aspx)
- [+ (Concatenação de cadeias)](https://msdn.microsoft.com/library/ms177561.aspx)
...
## <a name="wildcard-characters-to-match"></a>Caracteres universais para corresponder ao
...
- [> = (Grã ou igual a)](https://msdn.microsoft.com/library/ms181567.aspx)
...
- [| (Ou bit a bit)](https://msdn.microsoft.com/library/ms186714.aspx)
...
- [^ = (Exclusivo bit a bit ou é igual a)](https://msdn.microsoft.com/library/cc627413.aspx)
- [| = (Ou bit a bit igual a)](https://msdn.microsoft.com/library/cc627409.aspx)
- [& = (e bit a bit é igual a)](https://msdn.microsoft.com/library/cc627427.aspx)
...
- [MAIÚSCULAS/MINÚSCULAS](https://msdn.microsoft.com/library/ms181765.aspx)
- [CAST e converter em](https://msdn.microsoft.com/library/ms187928.aspx)
- [ARRED. EXCESSO](https://msdn.microsoft.com/library/ms189818.aspx)
- [CARÁCT](https://msdn.microsoft.com/library/ms187323.aspx)
...
- [ADESÃO](https://msdn.microsoft.com/library/ms190349.aspx)
...
- [COMPRIMENTODADOS](https://msdn.microsoft.com/library/ms173486.aspx)
...
- [FIMMÊS](https://msdn.microsoft.com/library/hh213020.aspx)
...
- [ÉNULO](https://msdn.microsoft.com/library/ms184325.aspx)
- [ISNUMERIC](https://msdn.microsoft.com/library/ms186272.aspx)
- [TEMPO DE DESFASAMENTO](https://msdn.microsoft.com/library/hh231256.aspx)
...
- [NÚM. CARAT](https://msdn.microsoft.com/library/ms190329.aspx)
- [REGISTO](https://msdn.microsoft.com/library/ms190319.aspx)
- [LOG10](https://msdn.microsoft.com/library/ms175121.aspx)
- [INFERIOR](https://msdn.microsoft.com/library/ms174400.aspx)
- [FUNÇÕES SUPRESQ](https://msdn.microsoft.com/library/ms177827.aspx)
- [MÁXIMO](https://msdn.microsoft.com/library/ms187751.aspx)
- [MÍNIMO](https://msdn.microsoft.com/library/ms179916.aspx)
...
- [CRIAR UMA RÉPLICA](https://msdn.microsoft.com/library/ms174383.aspx)
- [INVERTER](https://msdn.microsoft.com/library/ms180040.aspx)
- [PARA A DIREITA](https://msdn.microsoft.com/library/ms177532.aspx)
- [ARREDONDAR](https://msdn.microsoft.com/library/ms175003.aspx)
- [NÚM_LINHA](https://msdn.microsoft.com/library/ms186734.aspx)
...
- [RAIZQ](https://msdn.microsoft.com/library/ms176108.aspx)
...
- [CONTEÚDOS](https://msdn.microsoft.com/library/ms188043.aspx)
...
- [CANTO SUPERIOR](https://msdn.microsoft.com/library/ms180055.aspx)
- [UTILIZADOR](https://msdn.microsoft.com/library/ms186738.aspx)
- [NOMEDOUTILIZADOR](https://msdn.microsoft.com/library/ms188014.aspx)
...
## <a name="set-statements"></a>CONJUNTO de declarações
...
- [CONJUNTO ANSI_NULLS](https://msdn.microsoft.com/library/ms188048.aspx)
...
- [CONJUNTO DATEFIRST](https://msdn.microsoft.com/library/ms181598.aspx)
- [DEFINIR FORMATODEDATA](https://msdn.microsoft.com/library/ms189491.aspx)
...
- [CONJUNTO ROWCOUNT](https://msdn.microsoft.com/library/ms188774.aspx)
- [TAMANHO DO TEXTO DO CONJUNTO](https://msdn.microsoft.com/library/ms186238.aspx)
- [DEFINIR O NÍVEL DE ISOLAMENTO DA TRANSAÇÃO](https://msdn.microsoft.com/library/ms173763.aspx)
