<properties
   pageTitle="Utilizar o conector SMTP nas aplicações de lógica | Aplicação de serviço do Microsoft Azure"
   description="Como criar e configurar a aplicação de conector SMTP ou API e utilizá-la numa aplicação lógica na aplicação de serviço do Azure"
   services="logic-apps"
...
# <a name="weve-improved-the-smtp-connector"></a>Vamos tenha melhorada o conector SMTP 
...
- [Saber mais sobre a nova conexão](../connectors/connectors-create-api-smtp.md)
