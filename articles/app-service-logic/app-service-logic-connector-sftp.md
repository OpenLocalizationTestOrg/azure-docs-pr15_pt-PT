<properties
    pageTitle="Utilizando o conector SFTP nas aplicações de lógica | Aplicação de serviço do Microsoft Azure"
    description="Como criar e configurar a aplicação de conector de SFTP ou API e utilizá-la numa aplicação lógica na aplicação de serviço do Azure"
    authors="msftman"
    manager="erikre"
    editor=""
    services="logic-apps"
...
# <a name="weve-improved-the-sftp-connector"></a>Vamos tenha melhorada o conector SFTP 
...
- [Saber mais sobre a nova conexão](../connectors/connectors-create-api-sftp.md)
