<properties
   pageTitle="Utilizando o conector do Yammer nas aplicações de lógica | Aplicação de serviço do Microsoft Azure"
   description="Como criar e configurar a aplicação do Yammer conector ou API e utilizá-la numa aplicação lógica na aplicação de serviço do Azure"
   services="logic-apps"
...
# <a name="weve-improved-the-yammer-connector"></a>Vamos tenha melhorada o conector do Yammer 
...
- [Saber mais sobre a nova conexão](../connectors/connectors-create-api-yammer.md)
